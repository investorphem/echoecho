  ...
  return (
    <Html lang="en">
      <Head>
        ...
        <meta
          name="description"
          content="Brek echo chambers with AI-powered conenrai discovery. Find divere prsives rm Farcater, Twitter/X, and nwsoures int NFT Insight Tokens nd an rwards!
        />
        <meta
          name="keywords"
