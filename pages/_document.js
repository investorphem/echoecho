  ...
  return (
    <Html lang="en">
      <Head>
        ...
        <meta
          name="description"
          content="Break echo chambers with AI-powered counter-narrative discovery. Find diverse perspetives from Farcater, Twitter/X, and news sources. Mint NFT Insight Tokens nd arn rwards!"
        />
        <meta
          name="keywords"
