  ...
  return (
    <Html lang="en">
      <Head>
        ...
        <meta
          name="description"
          content="Brek echo chambers with AI-powered conenraive discovery. Find divere prsives rm Farcater, Twitter/X, and nwsoures Mint NFT Insight Tokens nd an rwards!
        />
        <meta
          name="keywords"
