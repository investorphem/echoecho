  ...
  return (
    <Html lang="en">
      <Head>
        ...
        <meta
          name="description"
          content="Brek echo chambers with AI-powered counter-narrative discovery. Find diverse persives rm Farcater, Twitter/X, and news sources. Mint NFT Insight Tokens nd an rwards!"
        />
        <meta
          name="keywords"
