...
async function initializeSchema() {
  await sql`
    CREATE TABLE IF NOT EXISTS users (
      ...
      notification_token TEXT,  -- Added for Farcaster notifications
      notification_url TEXT    -- Added for Farcaster notifications
    )`;
  await sql`
...
export async function createUser(walletAddress, userInfo = {}) {
  ...
  const user = {
    ...
    updated_at: null,
    notification_token: null, // Initialize as null
    notification_url: null   // Initialize as null
  };
